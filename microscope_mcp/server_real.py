...
from mcp.types import Resource, BinaryResourceContents
import io
...
#    """Raw camera frame as uint16 bytes"""
#    # Example frame
#    #frame = (np.random.rand(*IMAGE_SHAPE) * 4095).astype(DTYPE)
#    frame = scope.pixels
#    return Resource(
#        uri="resource://latest.raw",
